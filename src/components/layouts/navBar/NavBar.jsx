    ...
    <AppBar position="sticky" sx={{ backgroundColor: "#28a745" }}>
      <Toolbar sx={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
        ...
        <Box sx={{ display: "flex", justifyContent: "center", flexGrow: 1 }}>
          <Button 
            variant="text" 
            sx={{ color: "white", marginRight: "20px", "&:hover": { backgroundColor: "#218838" } }}
            component={Link} 
            to="/"
          >
            Inicio
        ...
        >
          <img 
            src="https://res.cloudinary.com/deetmxogb/image/upload/v1739141875/carrito_wchc2m.png" 
            alt="Carrito de Compras" 
            style={{ width: "50px", height: "50px", objectFit: "contain" }} 
          />
          <Badge 
            badgeContent={3} // Número de artículos en el carrito
            color="error" 
            sx={{
              position: "absolute",
              top: 0,
